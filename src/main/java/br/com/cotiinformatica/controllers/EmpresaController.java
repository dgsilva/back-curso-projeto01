...
import br.com.cotiinformatica.request.EmpresaPostRequest;
import br.com.cotiinformatica.request.EmpresaPutRequest;
	...
	public ResponseEntity<EmpresaResponse> delete(@PathVariable("id") Integer id) {
		...
		try {
			...
			if(registro.isPresent()) {
				...
				//verificando a quantidade de funcionários da empresa
				Integer qtdFuncionarios = empresaRepository.countFuncionarios(id);
